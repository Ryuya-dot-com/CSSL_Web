...
日本語母語話者向けの英語語彙CSSL実験です。web版は、`Experiment/README.md` と `Experiment/stimuli_map.json` の現在の研究計画に合わせ、Berens et al. (2018) のpre-scanner trainingとin-scanner taskをブラウザ上で一続きに実施する構成にしています。
...
- Main test: conditionごとに9物体の3x3グリッドを提示し、音声キュー後1100msから反応可能。
